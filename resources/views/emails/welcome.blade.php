...
<body class="bg-light"
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Here is a very simple card. It has responsive
                                                                        padding so it gets less padding on mobile to
                                                                        fill the screen more.
                                                                        Hopefully it can be useful to you. It is very
                                                                        simple and basic but can be used for a lot of
                                                                        simple emails.
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                                                        border="0" cellpadding="0" cellspacing="0"
    ...
    <script defer
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"2b43a5b0e6004ee2b96f84a5971604b6","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
